...
public class SpecialObj306EndlessSpellReroller : InteractiveObj
{
	...
	private void Start()
	{
		...
		interactiveEntity = RegisterDotsInteractiveObj(CC, InteractiveObjType.SO306EndlessReroll);
		Hide();
	}
	...
	public override void Interact()
	{
		...
		{
			GameUISingletonMono<UIReroll>.ShowInit(interactiveEntity);
		}
	}
}
