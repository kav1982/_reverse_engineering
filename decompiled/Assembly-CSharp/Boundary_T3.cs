...
public class Boundary_T3 : BoundaryBase
{
	[Space(50f)]
	...
	public override void Correct(Vector2Data selfPoint, RoomController roomCtrller)
	{
		...
		{
			if (roomCtrller.roomCfg.allTileList[0].Contains(selfPoint + new Vector2Data(0f, 2f)))
			{
		...
		else if (flag && flag3 && flag5 && !flag7)
		{
			...
			if (roomCtrller.roomCfg.boundarys.Contains(selfPoint + new Vector2Data(0f, -2f)) || roomCtrller.roomCfg.boundary2s.Contains(selfPoint + new Vector2Data(0f, -2f)))
			{
		...
		else if (flag && flag3 && flag5 && flag7)
		{
			...
			else if (!flag4)
			{
				...
				RandomDetail(selfPoint, roomCtrller, pfb_Detail_Corner_RD);
			}
			else if (!flag6)
			{
				if (roomCtrller.roomCfg.allTileList[0].Contains(selfPoint + new Vector2Data(0f, 2f)) || roomCtrller.roomCfg.allTileList[0].Contains(selfPoint + new Vector2Data(-1f, 2f)))
	...
	public override void Correct2(Vector2Data selfPoint, RoomController roomCtrller)
	{
		...
		if (Random.value <= ironChainChance)
		{
