...
public class Boundary_Normal : BoundaryBase
{
	[Space(50f)]
	...
	{
		go_Shadow.transform.position = Tool2D.GetLayerPoint(base.transform.position, LayerCorrectType.Shadow);
		bool flag = false;
		bool flag2 = false;
		bool flag3 = false;
		bool flag4 = false;
