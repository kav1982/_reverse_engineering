...
public class Tile_T0_Tile0Authoring : MonoBehaviour
{
	private class Baker : Baker<Tile_T0_Tile0Authoring>
	{
		public override void Bake(Tile_T0_Tile0Authoring authoring)
		{
			Entity entity = GetEntity(TransformUsageFlags.Dynamic);
			Tile_T0_Tile0_Dots component = default(Tile_T0_Tile0_Dots);
			...
			component.tile1Scale = authoring.tile1Scale;
			component.tile1Offset = authoring.tile1Offset;
