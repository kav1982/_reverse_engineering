...
[CompilerGenerated]
public struct Access_T1System : ISystem, ISystemCompilerGenerated
{
	[StructLayout(LayoutKind.Sequential, Size = 1)]
	private readonly struct IFE_1953306544_0
	{
		...
		public struct TypeHandle
		{
			...
			{
				item1_ComponentTypeHandle_RW = systemState.GetComponentTypeHandle<Access_T1_Dots>();
		...
		{
			state.EntityManager.CompleteDependencyBeforeRW<Access_T1_Dots>();
	...
	{
		public IFE_1953306544_0.TypeHandle __IFE_1953306544_0_TypeHandle;
		...
		{
			__IFE_1953306544_0_TypeHandle = new IFE_1953306544_0.TypeHandle(ref state);
	...
	internal delegate void __codegen__OnCreate_00005735_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnCreate_00005735_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_00005735_0024PostfixBurstDelegate>(delegate(IntPtr self, IntPtr state)
				{
					Invoke(self, state);
				}).Value;
			}
	...
	private EntityQuery __query_1953306544_0;

	private EntityQuery __query_1953306544_1;

	[BurstCompile]
	public void OnCreate(ref SystemState state)
	{
		state.RequireForUpdate<EndSimulationEntityCommandBufferSystem.Singleton>();
		state.RequireForUpdate<Access_T1_Dots>();
	}

	public void OnUpdate(ref SystemState state)
	{
		EntityCommandBuffer ecb = __query_1953306544_1.GetSingleton<EndSimulationEntityCommandBufferSystem.Singleton>().CreateCommandBuffer(state.WorldUnmanaged);
		foreach (QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Access_T1_Dots>, InternalCompilerInterface.UncheckedRefRW<InteractiveObj_Dots>, InternalCompilerInterface.UncheckedRefRW<AccessBase_Dots>, InternalCompilerInterface.UncheckedRefRW<PhysicsCollider>, LocalTransform> item6 in IFE_1953306544_0.Query(__query_1953306544_0, __TypeHandle.__IFE_1953306544_0_TypeHandle, ref state))
		{
			item6.Deconstruct(out var item, out var item2, out var item3, out var item4, out var item5, out var entity);
			InternalCompilerInterface.UncheckedRefRW<Access_T1_Dots> uncheckedRefRW = item;
			...
			if (uncheckedRefRW3.ValueRW.onOpenDirect)
			{
				...
				if (uncheckedRefRW3.ValueRW.needKey)
				{
					if (uncheckedRefRW3.ValueRW.alreadyUseKey)
					{
						...
						InternalCompilerInterface.GetComponentRWAfterCompletingDependency(ref __TypeHandle.__MatOverrideOffset_RW_ComponentLookup, ref state, uncheckedRefRW.ValueRW.ett_Access).ValueRW.offset = new float2(0f, uncheckedRefRW.ValueRW.openCurrentYOffset);
						InternalCompilerInterface.GetComponentRWAfterCompletingDependency(ref __TypeHandle.__MatOverrideOffset_RW_ComponentLookup, ref state, uncheckedRefRW.ValueRW.ett_AccessNotNeedKey).ValueRW.offset = new float2(0f, uncheckedRefRW.ValueRW.openCurrentYOffset);
	...
	private void __AssignQueries(ref SystemState state)
	{
		...
		entityQueryBuilder2 = entityQueryBuilder2.WithAllRW<Access_T1_Dots>();
	...
	{
		__codegen__OnCreate_00005735_0024BurstDirectCall.Invoke(self, state);
	}
	...
	{
		((Access_T1System*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
	}
}
