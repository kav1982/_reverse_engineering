...
public record Curse
{
	...
	public static List<Curse> CreateAuto()
	{
		return PlayerMgr.Inst.BaData.curseIDs.Select((int t, int i) => new Curse
		{
			id = t,
			level = PlayerMgr.Inst.BaData.curseLevels[i]
		}).ToList();
	}
	...
	[CompilerGenerated]
	public virtual bool Equals(Curse? other)
	{
	...
	[CompilerGenerated]
	protected Curse(Curse original)
	{
		id = original.id;
