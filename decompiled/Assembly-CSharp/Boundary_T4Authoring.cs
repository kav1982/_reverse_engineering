...
public class Boundary_T4Authoring : MonoBehaviour
{
	private class Baker : Baker<Boundary_T4Authoring>
	{
		public override void Bake(Boundary_T4Authoring authoring)
		{
			Entity entity = GetEntity(TransformUsageFlags.Dynamic);
			Boundary_T4_Dots component = default(Boundary_T4_Dots);
