...
[CompilerGenerated]
[BurstCompile]
internal struct ToiletSystem : ISystem, ISystemCompilerGenerated
{
	...
	internal delegate void __codegen__OnCreate_00005611_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnCreate_00005611_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_00005611_0024PostfixBurstDelegate>(delegate(IntPtr self, IntPtr state)
				{
					Invoke(self, state);
				}).Value;
			}
	...
	private EntityQuery __query_27859200_0;

	[BurstCompile]
	public void OnCreate(ref SystemState state)
	{
		state.RequireForUpdate<Toilet>();
	}

	public void OnUpdate(ref SystemState state)
	{
		Entity singletonEntity = __query_27859200_0.GetSingletonEntity();
	...
	private void __AssignQueries(ref SystemState state)
	{
		...
		EntityQueryBuilder entityQueryBuilder2 = entityQueryBuilder.WithAll<Toilet>();
		entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
		__query_27859200_0 = entityQueryBuilder2.Build(ref state);
	...
	{
		__codegen__OnCreate_00005611_0024BurstDirectCall.Invoke(self, state);
	}
	...
	{
		((ToiletSystem*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
	}
}
