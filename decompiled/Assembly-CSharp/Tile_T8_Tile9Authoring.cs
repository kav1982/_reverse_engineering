...
public class Tile_T8_Tile9Authoring : MonoBehaviour
{
	private class Baker : Baker<Tile_T8_Tile9Authoring>
	{
		public override void Bake(Tile_T8_Tile9Authoring authoring)
		{
			Entity entity = GetEntity(TransformUsageFlags.Dynamic);
			Tile_T8_Tile9_Dots component = new Tile_T8_Tile9_Dots
			{
