...
public class Boundary_T11Authoring : MonoBehaviour
{
	private class Baker : Baker<Boundary_T11Authoring>
	{
		public override void Bake(Boundary_T11Authoring authoring)
		{
			Entity entity = GetEntity(TransformUsageFlags.Dynamic);
			Boundary_T11_Dots component = default(Boundary_T11_Dots);
