...
public class Boss3Laser : MonoBehaviour
{
	...
	public Material mt_Warning_H;

	public Transform tsf_Node1_H;

	public Transform tsf_Node2_H;

	public Transform tsf_Node1_Warning_H;

	public Transform tsf_Node2_Warning_H;
	...
	private void Start()
	{
		...
		{
			Object.Destroy(lr_Laser_Warning.material);
			lr_Laser_Warning.material = mt_Warning_H;
			Object.Destroy(lr_Laser.material);
			lr_Laser.material = mt_H;
			tsf_Node1 = tsf_Node1_H;
			tsf_Node2 = tsf_Node2_H;
			tsf_Node1_Warning = tsf_Node1_Warning_H;
			tsf_Node2_Warning = tsf_Node2_Warning_H;
		}
	}
