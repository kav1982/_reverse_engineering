...
public class Tile_T9_Tile9 : TileBase
{
	[Space(50f)]
	...
	[Header("Obstacle")]
	public GameObject go_Collider_Full;

	public GameObject go_Collider_Null;

	public GameObject go_Collider_UR;

	public GameObject go_ColliderSmall_U;
	...
	public override void TileCorrect(Vector2Data selfPoint, List<Vector2Data> otherTilePoints)
	{
		...
		if (!flag && !flag3 && !flag5 && !flag7)
		{
			...
			go_Collider_Null.SetActive(value: true);
		}
		else if (flag && !flag3 && !flag5 && !flag7)
		{
			...
			go_ColliderSmall_U.SetActive(value: true);
		}
		else if (!flag && flag3 && !flag5 && !flag7)
		{
			...
			go_ColliderSmall_U.SetActive(value: true);
			go_ColliderSmall_U.transform.rotation = Quaternion.Euler(0f, 0f, 270f);
		}
		else if (!flag && !flag3 && flag5 && !flag7)
		{
			...
			go_ColliderSmall_U.SetActive(value: true);
			go_ColliderSmall_U.transform.rotation = Quaternion.Euler(0f, 0f, 180f);
		}
		else if (!flag && !flag3 && !flag5 && flag7)
		{
			sr_Base.sprite = sprite_Base_R[Random.Range(0, sprite_Base_R.Length)];
			...
			sr_Wall.flipX = true;
			go_ColliderSmall_U.SetActive(value: true);
			go_ColliderSmall_U.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
		}
		else if (flag && !flag3 && flag5 && !flag7)
		{
			...
			go_Collider_Full.SetActive(value: true);
		}
		else if (!flag && flag3 && !flag5 && flag7)
		{
		...
		else if (flag && flag3 && !flag5 && !flag7)
		{
			...
			go_Collider_UR.SetActive(value: true);
		}
		else if (!flag && flag3 && flag5 && !flag7)
		{
			...
			go_Collider_UR.SetActive(value: true);
			go_Collider_UR.transform.rotation = Quaternion.Euler(0f, 0f, 270f);
		}
		else if (!flag && !flag3 && flag5 && flag7)
		{
			sr_Base.sprite = sprite_Base_RD[Random.Range(0, sprite_Base_RD.Length)];
			...
			go_Collider_UR.SetActive(value: true);
			go_Collider_UR.transform.rotation = Quaternion.Euler(0f, 0f, 180f);
		}
		else if (flag && !flag3 && !flag5 && flag7)
		{
			sr_Base.sprite = sprite_Base_UR[Random.Range(0, sprite_Base_UR.Length)];
			...
			go_Collider_UR.SetActive(value: true);
			go_Collider_UR.transform.rotation = Quaternion.Euler(0f, 0f, 90f);
		}
		else if (flag && flag3 && !flag5 && flag7)
		{
