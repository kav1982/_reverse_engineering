...
public class SteamFriendsCustom : MonoBehaviour
{
	public enum State
	{
		Idle,
	...
	public static SteamFriendsCustom Inst;

	public int UpdageFrequence = 300;
	...
	public static List<CSteamID> friends = new List<CSteamID>();
	...
	public int FrientCount => friends.Count;

	public void Update()
	{
	}

	public void GetAllFiends()
	{
		if (base.enabled)
		{
			friends.Clear();
	...
	{
		Debug.Log("[" + 331 + " - GameOverlayActivated] - " + pCallback.m_bActive);
	}
