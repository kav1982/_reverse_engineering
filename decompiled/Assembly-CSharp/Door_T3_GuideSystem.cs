...
[BurstCompile]
[CompilerGenerated]
public struct Door_T3_GuideSystem : ISystem, ISystemCompilerGenerated
{
	[StructLayout(LayoutKind.Sequential, Size = 1)]
	private readonly struct IFE_1737813237_0
	{
		...
		public struct TypeHandle
		{
			...
			{
				item1_ComponentTypeHandle_RW = systemState.GetComponentTypeHandle<Door_T3_Guide>();
		...
		{
			state.EntityManager.CompleteDependencyBeforeRW<Door_T3_Guide>();
	...
	{
		public IFE_1737813237_0.TypeHandle __IFE_1737813237_0_TypeHandle;
		...
		{
			__IFE_1737813237_0_TypeHandle = new IFE_1737813237_0.TypeHandle(ref state);
	...
	internal delegate void __codegen__OnCreate_00005A3F_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnCreate_00005A3F_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_00005A3F_0024PostfixBurstDelegate>(delegate(IntPtr self, IntPtr state)
				{
					Invoke(self, state);
				}).Value;
			}
	...
	private EntityQuery __query_1737813237_0;

	private EntityQuery __query_1737813237_1;

	[BurstCompile]
	public void OnCreate(ref SystemState state)
	{
		state.RequireForUpdate<EndSimulationEntityCommandBufferSystem.Singleton>();
		state.RequireForUpdate<Door_T3_Guide>();
	}

	public void OnUpdate(ref SystemState state)
	{
		bool flag = false;
		foreach (QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Door_T3_Guide>, InternalCompilerInterface.UncheckedRefRW<PhysicsCollider>, InternalCompilerInterface.UncheckedRefRW<DoorBase_Dots>, LocalTransform, InternalCompilerInterface.UncheckedRefRW<InteractiveObj_Dots>> item6 in IFE_1737813237_0.Query(__query_1737813237_0, __TypeHandle.__IFE_1737813237_0_TypeHandle, ref state))
		{
			item6.Deconstruct(out var item, out var item2, out var item3, out var item4, out var item5, out var entity);
			InternalCompilerInterface.UncheckedRefRW<Door_T3_Guide> uncheckedRefRW = item;
			...
			if (!uncheckedRefRW.ValueRW.isInitialized)
			{
				...
				EntityCommandBuffer ecb = __query_1737813237_1.GetSingleton<EndSimulationEntityCommandBufferSystem.Singleton>().CreateCommandBuffer(state.WorldUnmanaged);
	...
	private void __AssignQueries(ref SystemState state)
	{
		...
		entityQueryBuilder2 = entityQueryBuilder2.WithAllRW<Door_T3_Guide>();
	...
	{
		__codegen__OnCreate_00005A3F_0024BurstDirectCall.Invoke(self, state);
	}
	...
	{
		((Door_T3_GuideSystem*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
	}
}
