...
[BurstCompile]
[CompilerGenerated]
public struct Tile_T12_Tile5Job : IJobEntity, IJobChunk
{
	public struct InternalCompilerQueryAndHandleData
	{
		...
		{
			[ReadOnly]
			public ComponentTypeHandle<Tile_T12_Tile5_Dots> __Tile_T12_Tile5_Dots_RO_ComponentTypeHandle;
			...
			{
				__Tile_T12_Tile5_Dots_RO_ComponentTypeHandle = state.GetComponentTypeHandle<Tile_T12_Tile5_Dots>(isReadOnly: true);
			...
			{
				__Tile_T12_Tile5_Dots_RO_ComponentTypeHandle.Update(ref state);
		...
		private void __AssignQueries(ref SystemState state)
		{
			...
			EntityQueryBuilder entityQueryBuilder2 = entityQueryBuilder.WithAll<Tile_T12_Tile5_Dots>();
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void Run(ref Tile_T12_Tile5Job job, EntityQuery query)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public JobHandle Schedule(ref Tile_T12_Tile5Job job, EntityQuery query, JobHandle dependency)
		{
			job.__TypeHandle = __TypeHandle;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public JobHandle ScheduleParallel(ref Tile_T12_Tile5Job job, EntityQuery query, JobHandle dependency)
		{
			job.__TypeHandle = __TypeHandle;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void UpdateBaseEntityIndexArray(ref Tile_T12_Tile5Job job, EntityQuery query, ref SystemState state)
		{
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public JobHandle UpdateBaseEntityIndexArray(ref Tile_T12_Tile5Job job, EntityQuery query, JobHandle dependency, ref SystemState state)
		{
			return dependency;
		}

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void AssignEntityManager(ref Tile_T12_Tile5Job job, EntityManager entityManager)
		{
		}
	}
	...
	public void Execute([ChunkIndexInQuery] int index, in Tile_T12_Tile5_Dots tile, in TileBase_Dots tileBase, ref LocalTransform localTsf, Entity ett)
	{
		...
		ecb.SetComponentEnabled<Tile_T12_Tile5_Dots>(index, ett, value: false);
	}

	[CompilerGenerated]
	public void Execute(in ArchetypeChunk chunk, int chunkIndexInQuery, bool useEnabledMask, in v128 chunkEnabledMask)
	{
		IntPtr nativeArrayPtr = InternalCompilerInterface.UnsafeGetChunkNativeArrayReadOnlyIntPtr(chunk, ref __TypeHandle.__Tile_T12_Tile5_Dots_RO_ComponentTypeHandle);
		...
		if (!useEnabledMask)
		{
			...
			{
				ref Tile_T12_Tile5_Dots tile = ref InternalCompilerInterface.UnsafeGetRefToNativeArrayPtrElement<Tile_T12_Tile5_Dots>(nativeArrayPtr, i);
		...
		if (math.countbits(chunkEnabledMask.ULong0 ^ (chunkEnabledMask.ULong0 << 1)) + math.countbits(chunkEnabledMask.ULong1 ^ (chunkEnabledMask.ULong1 << 1)) - 1 <= 4)
		{
			...
			while (InternalCompilerInterface.UnsafeTryGetNextEnabledBitRange(chunkEnabledMask, nextRangeEnd, out nextRangeBegin, out nextRangeEnd))
			{
				...
				{
					ref Tile_T12_Tile5_Dots tile2 = ref InternalCompilerInterface.UnsafeGetRefToNativeArrayPtrElement<Tile_T12_Tile5_Dots>(nativeArrayPtr, nextRangeBegin);
		...
		for (int j = 0; j < num3; j++)
		{
			if ((num2 & 1) != 0L)
			{
				ref Tile_T12_Tile5_Dots tile3 = ref InternalCompilerInterface.UnsafeGetRefToNativeArrayPtrElement<Tile_T12_Tile5_Dots>(nativeArrayPtr, j);
		...
		for (int k = 64; k < count; k++)
		{
			if ((num2 & 1) != 0L)
			{
				ref Tile_T12_Tile5_Dots tile4 = ref InternalCompilerInterface.UnsafeGetRefToNativeArrayPtrElement<Tile_T12_Tile5_Dots>(nativeArrayPtr, k);
