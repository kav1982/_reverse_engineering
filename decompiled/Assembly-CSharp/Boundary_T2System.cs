...
public struct Boundary_T2System : ISystem, ISystemCompilerGenerated
{
	[StructLayout(LayoutKind.Sequential, Size = 1)]
	private readonly struct IFE_2050488034_0
	{
		public struct ResolvedChunk
		{
			...
			public QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Boundary_T2_Dots>, InternalCompilerInterface.UncheckedRefRO<BoundaryBase_Dots>, BoundaryT2RoomCtrller, InternalCompilerInterface.UncheckedRefRW<LocalTransform>> Get(int index)
			{
				return new QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Boundary_T2_Dots>, InternalCompilerInterface.UncheckedRefRO<BoundaryBase_Dots>, BoundaryT2RoomCtrller, InternalCompilerInterface.UncheckedRefRW<LocalTransform>>(InternalCompilerInterface.UnsafeGetUncheckedRefRW<Boundary_T2_Dots>(item1_IntPtr, index), InternalCompilerInterface.UnsafeGetUncheckedRefRO<BoundaryBase_Dots>(item2_IntPtr, index), item3_ManagedComponentAccessor[index], InternalCompilerInterface.UnsafeGetUncheckedRefRW<LocalTransform>(item4_IntPtr, index), InternalCompilerInterface.UnsafeGetCopyOfNativeArrayPtrElement<Entity>(Entity_IntPtr, index));
			}
		}
		...
		public struct TypeHandle
		{
			...
			private ComponentTypeHandle<Boundary_T2_Dots> item1_ComponentTypeHandle_RW;
			...
			public TypeHandle(ref SystemState systemState)
			{
				...
				item1_ComponentTypeHandle_RW = systemState.GetComponentTypeHandle<Boundary_T2_Dots>();
		...
		public struct Enumerator : IEnumerator<QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Boundary_T2_Dots>, InternalCompilerInterface.UncheckedRefRO<BoundaryBase_Dots>, BoundaryT2RoomCtrller, InternalCompilerInterface.UncheckedRefRW<LocalTransform>>>, IEnumerator, IDisposable
		{
			...
			public QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Boundary_T2_Dots>, InternalCompilerInterface.UncheckedRefRO<BoundaryBase_Dots>, BoundaryT2RoomCtrller, InternalCompilerInterface.UncheckedRefRW<LocalTransform>> Current => _resolvedChunk.Get(_currentEntityIndex);
		...
		{
			state.EntityManager.CompleteDependencyBeforeRW<Boundary_T2_Dots>();
	...
	{
		public IFE_2050488034_0.TypeHandle __IFE_2050488034_0_TypeHandle;
		...
		{
			__IFE_2050488034_0_TypeHandle = new IFE_2050488034_0.TypeHandle(ref state);
			__Unity_Transforms_LocalTransform_RW_ComponentLookup = state.GetComponentLookup<LocalTransform>();
		}
	}

	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void __codegen__OnCreate_00005924_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnCreate_00005924_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_00005924_0024PostfixBurstDelegate>(delegate(IntPtr self, IntPtr state)
				{
					Invoke(self, state);
				}).Value;
			}
	...
	private EntityQuery __query_2050488034_0;

	private EntityQuery __query_2050488034_1;

	private EntityQuery __query_2050488034_2;

	private EntityQuery __query_2050488034_3;
	...
	public void OnCreate(ref SystemState state)
	{
		...
		state.RequireForUpdate<Boundary_T2_Dots>();
	}

	public void OnUpdate(ref SystemState state)
	{
		EntityCommandBuffer ecb = __query_2050488034_1.GetSingleton<EndSimulationEntityCommandBufferSystem.Singleton>().CreateCommandBuffer(state.WorldUnmanaged);
		RefRW<GlobalRandom> singletonRW = __query_2050488034_2.GetSingletonRW<GlobalRandom>();
		foreach (QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Boundary_T2_Dots>, InternalCompilerInterface.UncheckedRefRO<BoundaryBase_Dots>, BoundaryT2RoomCtrller, InternalCompilerInterface.UncheckedRefRW<LocalTransform>> item5 in IFE_2050488034_0.Query(__query_2050488034_0, __TypeHandle.__IFE_2050488034_0_TypeHandle, ref state))
		{
			item5.Deconstruct(out var item, out var item2, out var item3, out var item4, out var entity);
			InternalCompilerInterface.UncheckedRefRW<Boundary_T2_Dots> uncheckedRefRW = item;
			...
			{
				UnityEngine.Object.Instantiate(ABResources.LoadAsset<GameObject>("Prefabs/Mixed/NavAction"), uncheckedRefRW2.ValueRO.Position + new float3(0f, -0.15f, 0f), Quaternion.identity, boundaryT2RoomCtrller.roomCtrller.tsf_Action);
				UnityEngine.Object.Instantiate(ABResources.LoadAsset<GameObject>("Prefabs/Mixed/NavGround"), uncheckedRefRW2.ValueRO.Position + new float3(0f, -0.15f, 0f), Quaternion.identity, boundaryT2RoomCtrller.roomCtrller.tsf_Ground);
				UnityEngine.Object.Instantiate(ABResources.LoadAsset<GameObject>("Prefabs/Mixed/NavFly"), uncheckedRefRW2.ValueRO.Position + new float3(0f, -0.15f, 0f), Quaternion.identity, boundaryT2RoomCtrller.roomCtrller.tsf_Fly);
				flag14 = true;
				flag23 = true;
				uncheckedRefRW2.ValueRW.Position += new float3(0f, 0f, 0.0049f);
				Entity e2 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Small);
				ecb.SetComponent(e2, new LocalTransform
				{
			...
			{
				UnityEngine.Object.Instantiate(ABResources.LoadAsset<GameObject>("Prefabs/Mixed/NavAction"), uncheckedRefRW2.ValueRO.Position, Quaternion.identity, boundaryT2RoomCtrller.roomCtrller.tsf_Action);
				UnityEngine.Object.Instantiate(ABResources.LoadAsset<GameObject>("Prefabs/Mixed/NavGround"), uncheckedRefRW2.ValueRO.Position, Quaternion.identity, boundaryT2RoomCtrller.roomCtrller.tsf_Ground);
				UnityEngine.Object.Instantiate(ABResources.LoadAsset<GameObject>("Prefabs/Mixed/NavFly"), uncheckedRefRW2.ValueRO.Position, Quaternion.identity, boundaryT2RoomCtrller.roomCtrller.tsf_Fly);
				flag11 = true;
			}
			else if (!flag && !flag3 && flag5 && !flag7)
			{
				...
				flag19 = true;
				uncheckedRefRW2.ValueRW.Position += new float3(0f, 0f, -0.0049f);
				Entity e3 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Small);
			...
			else if (flag && flag3 && !flag5 && !flag7)
			{
				...
				{
					DynamicBuffer<SceneEttBED> singletonBuffer = __query_2050488034_3.GetSingletonBuffer<SceneEttBED>();
					if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme2_Chapter2_Oblique)
					{
						Entity e4 = ecb.Instantiate(singletonBuffer[0].ett_Boundary);
						ecb.SetComponent(e4, uncheckedRefRO.ValueRO);
					}
					else if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme20_Chapter2_Shortcut3)
					{
						Entity e5 = ecb.Instantiate(singletonBuffer[18].ett_Boundary);
						ecb.SetComponent(e5, uncheckedRefRO.ValueRO);
					}
					ecb.DestroyEntity(e);
					continue;
				}
				...
				flag24 = true;
				uncheckedRefRW2.ValueRW.Position += new float3(0f, 0f, 0.0049f);
				Entity e6 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Big);
				ecb.SetComponent(e6, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
					Rotation = quaternion.identity,
					Scale = 1f
			...
			else if (!flag && flag3 && flag5 && !flag7)
			{
				...
				{
					DynamicBuffer<SceneEttBED> singletonBuffer2 = __query_2050488034_3.GetSingletonBuffer<SceneEttBED>();
					if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme2_Chapter2_Oblique)
					{
						Entity e7 = ecb.Instantiate(singletonBuffer2[0].ett_Boundary);
						ecb.SetComponent(e7, uncheckedRefRO.ValueRO);
					}
					else if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme20_Chapter2_Shortcut3)
					{
						Entity e8 = ecb.Instantiate(singletonBuffer2[18].ett_Boundary);
			...
			else if (!flag && !flag3 && flag5 && flag7)
			{
				...
				{
					DynamicBuffer<SceneEttBED> singletonBuffer3 = __query_2050488034_3.GetSingletonBuffer<SceneEttBED>();
					if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme2_Chapter2_Oblique)
					{
						Entity e10 = ecb.Instantiate(singletonBuffer3[0].ett_Boundary);
						ecb.SetComponent(e10, uncheckedRefRO.ValueRO);
					}
					else if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme20_Chapter2_Shortcut3)
					{
						Entity e11 = ecb.Instantiate(singletonBuffer3[18].ett_Boundary);
						ecb.SetComponent(e11, uncheckedRefRO.ValueRO);
					}
					ecb.DestroyEntity(e);
					continue;
				}
				...
				Entity e12 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Big);
			...
			else if (flag && !flag3 && !flag5 && flag7)
			{
				...
				{
					DynamicBuffer<SceneEttBED> singletonBuffer4 = __query_2050488034_3.GetSingletonBuffer<SceneEttBED>();
					if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme2_Chapter2_Oblique)
					{
						Entity e13 = ecb.Instantiate(singletonBuffer4[0].ett_Boundary);
						ecb.SetComponent(e13, uncheckedRefRO.ValueRO);
					}
					else if (boundaryT2RoomCtrller.roomCtrller.roomCfg.themeType == RoomThemeType.Theme20_Chapter2_Shortcut3)
					{
						Entity e14 = ecb.Instantiate(singletonBuffer4[18].ett_Boundary);
						ecb.SetComponent(e14, uncheckedRefRO.ValueRO);
					}
					ecb.DestroyEntity(e);
					continue;
				}
				...
				Entity e15 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Big);
				ecb.SetComponent(e15, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
			...
			else if (flag && flag3 && !flag5 && flag7)
			{
				...
				flag10 = true;
				flag20 = true;
				Entity e16 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Full);
				ecb.SetComponent(e16, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
					Rotation = quaternion.identity,
					Scale = 1f
			...
			else if (flag && flag3 && flag5 && !flag7)
			{
				...
				flag16 = true;
				flag25 = true;
				Entity e17 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Full);
				ecb.SetComponent(e17, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
					Rotation = quaternion.identity,
					Scale = 1f
			...
			else if (!flag && flag3 && flag5 && flag7)
			{
				...
				flag22 = true;
				uncheckedRefRW2.ValueRW.Position += new float3(0f, 0f, -0.0049f);
				Entity e18 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Full);
				ecb.SetComponent(e18, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
					Rotation = quaternion.identity,
					Scale = 1f
			...
			else if (flag && !flag3 && flag5 && flag7)
			{
				...
				Entity e19 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Full);
				ecb.SetComponent(e19, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
					Rotation = quaternion.identity,
					Scale = 1f
			...
			else if (flag && flag3 && flag5 && flag7)
			{
				...
				Entity e20 = ecb.Instantiate(uncheckedRefRW.ValueRO.ett_Collider_Full);
				ecb.SetComponent(e20, new LocalTransform
				{
					Position = uncheckedRefRW2.ValueRO.Position,
					Rotation = quaternion.identity,
					Scale = 1f
			...
			if (!flag9)
			{
				ecb.DestroyEntity(uncheckedRefRW.ValueRO.ett_AO_D);
			}
			if (!flag10)
			{
			...
			if (!flag11)
			{
				ecb.DestroyEntity(uncheckedRefRW.ValueRO.ett_AO_R);
			}
			if (!flag12)
			{
			...
			if (!flag14)
			{
				ecb.DestroyEntity(uncheckedRefRW.ValueRO.ett_AO_U);
			}
			if (!flag15)
			{
			...
			if (!flag19)
			{
				ecb.DestroyEntity(uncheckedRefRW.ValueRO.ett_Wall_D);
			}
			if (!flag20)
			{
			...
			if (!flag23)
			{
				ecb.DestroyEntity(uncheckedRefRW.ValueRO.ett_Wall_U);
			}
			if (!flag24)
			{
			...
			ecb.SetComponentEnabled<Boundary_T2_Dots>(e, value: false);
		}
	}
	...
	private void __AssignQueries(ref SystemState state)
	{
		...
		entityQueryBuilder2 = entityQueryBuilder2.WithAllRW<Boundary_T2_Dots>();
		__query_2050488034_0 = entityQueryBuilder2.Build(ref state);
		entityQueryBuilder.Reset();
		entityQueryBuilder2 = entityQueryBuilder.WithAll<EndSimulationEntityCommandBufferSystem.Singleton>();
		entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
		__query_2050488034_1 = entityQueryBuilder2.Build(ref state);
		entityQueryBuilder.Reset();
		entityQueryBuilder2 = entityQueryBuilder.WithAllRW<GlobalRandom>();
		entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
		__query_2050488034_2 = entityQueryBuilder2.Build(ref state);
		entityQueryBuilder.Reset();
		entityQueryBuilder2 = entityQueryBuilder.WithAllRW<SceneEttBED>();
		entityQueryBuilder2 = entityQueryBuilder2.WithOptions(EntityQueryOptions.IncludeSystems);
		__query_2050488034_3 = entityQueryBuilder2.Build(ref state);
		entityQueryBuilder.Reset();
	...
	{
		__codegen__OnCreate_00005924_0024BurstDirectCall.Invoke(self, state);
	}
	...
	{
		((Boundary_T2System*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
	}
}
