...
[CompilerGenerated]
internal struct Monster23System : ISystem, ISystemCompilerGenerated
{
	[StructLayout(LayoutKind.Sequential, Size = 1)]
	private readonly struct IFE_1315293709_0
	{
		...
		public struct TypeHandle
		{
			...
			{
				item1_ComponentTypeHandle_RW = systemState.GetComponentTypeHandle<Monster23_Dots>();
		...
		public struct Enumerator : IEnumerator<QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Monster23_Dots>, InternalCompilerInterface.UncheckedRefRW<UnitBase_Dots>, InternalCompilerInterface.UncheckedRefRW<LocalTransform>, InternalCompilerInterface.UncheckedRefRW<PathFinding>, InternalCompilerInterface.UncheckedRefRW<UnitProperty_Dots>>>, IEnumerator, IDisposable
		{
			...
			public QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Monster23_Dots>, InternalCompilerInterface.UncheckedRefRW<UnitBase_Dots>, InternalCompilerInterface.UncheckedRefRW<LocalTransform>, InternalCompilerInterface.UncheckedRefRW<PathFinding>, InternalCompilerInterface.UncheckedRefRW<UnitProperty_Dots>> Current => _resolvedChunk.Get(_currentEntityIndex);
		...
		{
			state.EntityManager.CompleteDependencyBeforeRW<Monster23_Dots>();
	...
	{
		public IFE_1315293709_0.TypeHandle __IFE_1315293709_0_TypeHandle;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public void __AssignHandles(ref SystemState state)
		{
			__IFE_1315293709_0_TypeHandle = new IFE_1315293709_0.TypeHandle(ref state);
		}
	}

	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void __codegen__OnCreate_0000888E_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnCreate_0000888E_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnCreate_0000888E_0024PostfixBurstDelegate>(delegate(IntPtr self, IntPtr state)
				{
					Invoke(self, state);
				}).Value;
			}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void __codegen__OnDestroy_00008890_0024PostfixBurstDelegate(IntPtr self, IntPtr state);

	internal static class __codegen__OnDestroy_00008890_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<__codegen__OnDestroy_00008890_0024PostfixBurstDelegate>(delegate(IntPtr self, IntPtr state)
				{
					Invoke(self, state);
				}).Value;
			}
	...
	private EntityQuery __query_1315293709_0;

	[BurstCompile]
	public void OnCreate(ref SystemState state)
	{
		state.RequireForUpdate<Monster23_Dots>();
	}

	public void OnUpdate(ref SystemState state)
	{
		foreach (QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Monster23_Dots>, InternalCompilerInterface.UncheckedRefRW<UnitBase_Dots>, InternalCompilerInterface.UncheckedRefRW<LocalTransform>, InternalCompilerInterface.UncheckedRefRW<PathFinding>, InternalCompilerInterface.UncheckedRefRW<UnitProperty_Dots>> item6 in IFE_1315293709_0.Query(__query_1315293709_0, __TypeHandle.__IFE_1315293709_0_TypeHandle, ref state))
		{
			item6.Deconstruct(out var item, out var item2, out var item3, out var item4, out var item5, out var _);
			InternalCompilerInterface.UncheckedRefRW<Monster23_Dots> uncheckedRefRW = item;
			...
			ref Monster23_Dots valueRW = ref uncheckedRefRW.ValueRW;
			...
			{
			case Monster23State.BornIdle:
				if (valueRW.stateExistTime >= 0.5f)
				{
					valueRW.state = Monster23State.Roam;
				}
				break;
			case Monster23State.Roam:
				if (valueRW.changedState)
				{
					valueRW4.UpdatePath(valueRW3.Position, Tool2D.GetNavMeshPoint(valueRW3.Position, valueRW.roamRadius), 32);
				}
	...
	private void __AssignQueries(ref SystemState state)
	{
		...
		EntityQueryBuilder entityQueryBuilder2 = entityQueryBuilder.WithAllRW<Monster23_Dots>();
		...
		__query_1315293709_0 = entityQueryBuilder2.Build(ref state);
	...
	{
		__codegen__OnCreate_0000888E_0024BurstDirectCall.Invoke(self, state);
	}
	...
	{
		__codegen__OnDestroy_00008890_0024BurstDirectCall.Invoke(self, state);
	}
	...
	{
		((Monster23System*)self.ToPointer())->OnCreate(ref *(SystemState*)state.ToPointer());
	}
	...
	{
		((Monster23System*)self.ToPointer())->OnDestroy(ref *(SystemState*)state.ToPointer());
	}
}
