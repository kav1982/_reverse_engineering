...
[CompilerGenerated]
public struct Spell9026Elite15EffectSystem : ISystem, ISystemCompilerGenerated
{
	[StructLayout(LayoutKind.Sequential, Size = 1)]
	private readonly struct IFE_584084527_0
	{
		public struct ResolvedChunk
		{
			...
			public QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Spell9026Elite15Data>, InternalCompilerInterface.UncheckedRefRO<SpellMovementComponentData>, InternalCompilerInterface.UncheckedRefRO<LocalTransform>> Get(int index)
			{
				return new QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Spell9026Elite15Data>, InternalCompilerInterface.UncheckedRefRO<SpellMovementComponentData>, InternalCompilerInterface.UncheckedRefRO<LocalTransform>>(InternalCompilerInterface.UnsafeGetUncheckedRefRW<Spell9026Elite15Data>(item1_IntPtr, index), InternalCompilerInterface.UnsafeGetUncheckedRefRO<SpellMovementComponentData>(item2_IntPtr, index), InternalCompilerInterface.UnsafeGetUncheckedRefRO<LocalTransform>(item3_IntPtr, index), InternalCompilerInterface.UnsafeGetCopyOfNativeArrayPtrElement<Entity>(Entity_IntPtr, index));
			}
		}

		public struct TypeHandle
		{
			private ComponentTypeHandle<Spell9026Elite15Data> item1_ComponentTypeHandle_RW;
			...
			{
				item1_ComponentTypeHandle_RW = systemState.GetComponentTypeHandle<Spell9026Elite15Data>();
		...
		public struct Enumerator : IEnumerator<QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Spell9026Elite15Data>, InternalCompilerInterface.UncheckedRefRO<SpellMovementComponentData>, InternalCompilerInterface.UncheckedRefRO<LocalTransform>>>, IEnumerator, IDisposable
		{
			...
			public QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Spell9026Elite15Data>, InternalCompilerInterface.UncheckedRefRO<SpellMovementComponentData>, InternalCompilerInterface.UncheckedRefRO<LocalTransform>> Current => _resolvedChunk.Get(_currentEntityIndex);
		...
		{
			state.EntityManager.CompleteDependencyBeforeRW<Spell9026Elite15Data>();
	...
	{
		public IFE_584084527_0.TypeHandle __IFE_584084527_0_TypeHandle;
		...
		{
			__IFE_584084527_0_TypeHandle = new IFE_584084527_0.TypeHandle(ref state);
	...
	private EntityQuery __query_584084527_0;
	...
	{
		foreach (QueryEnumerableWithEntity<InternalCompilerInterface.UncheckedRefRW<Spell9026Elite15Data>, InternalCompilerInterface.UncheckedRefRO<SpellMovementComponentData>, InternalCompilerInterface.UncheckedRefRO<LocalTransform>> item4 in IFE_584084527_0.Query(__query_584084527_0, __TypeHandle.__IFE_584084527_0_TypeHandle, ref state))
		{
			item4.Deconstruct(out var item, out var _, out var item3, out var entity);
			InternalCompilerInterface.UncheckedRefRW<Spell9026Elite15Data> uncheckedRefRW = item;
			InternalCompilerInterface.UncheckedRefRO<LocalTransform> uncheckedRefRO = item3;
			Entity entity2 = entity;
			if (!uncheckedRefRW.ValueRO.SpellObj)
			{
				if (TryGetLinkEffect("Trail1", InternalCompilerInterface.GetBufferAfterCompletingDependency(ref __TypeHandle.__SpellGameObjectEffectLink_RW_BufferLookup, ref state, entity2), out var linkedObject))
				{
	...
	private void __AssignQueries(ref SystemState state)
	{
		...
		entityQueryBuilder2 = entityQueryBuilder2.WithAllRW<Spell9026Elite15Data>();
		__query_584084527_0 = entityQueryBuilder2.Build(ref state);
