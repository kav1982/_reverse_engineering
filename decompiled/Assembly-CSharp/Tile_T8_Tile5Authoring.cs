...
public class Tile_T8_Tile5Authoring : MonoBehaviour
{
	private class Baker : Baker<Tile_T8_Tile5Authoring>
	{
		public override void Bake(Tile_T8_Tile5Authoring authoring)
		{
			Entity entity = GetEntity(TransformUsageFlags.Dynamic);
			Tile_T8_Tile5_Dots component = new Tile_T8_Tile5_Dots
			{
