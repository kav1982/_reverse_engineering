...
public sealed class BuglyAgent
{
	...
	public delegate void ReportExceptionDelegate(string name, string reason, string stackTrace, string extras, bool quitProgram);
	...
	public static event ReportExceptionDelegate ReportExceptionEvent;
